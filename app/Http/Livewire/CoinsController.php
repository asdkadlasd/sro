...
class CoinsController extends Component
{
    ...
    public function Store()
    {
        ...
        $message = [
            'type.required' => 'Debe seleccionar el tipo para la denominación.',
            'type.not_in' => 'Debe elegir el tipo de denominación.',
            'value.required' => 'Debe escribir un valor para la denominación.',
            'value.unique' => 'Ya existe un valor con esa denominación',
            'image.image' => 'Debe seleccionar una imagen válida',
            'image.max' => 'La imagen no debe exceder de 1MB'
        ];
