                    ...
                    @else
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                {{-- <label style="color: #3b3f5c;">Seleccione el proveedor:</label>
                    ...
                    @else
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                {{-- <label style="color: #3b3f5c;">Seleccione el producto:</label>
                                <select id="productselect" wire:model="productid"
                                    wire:change="Edit(parseInt($('#productselect').val()))" class="form-control">
                                    <option value="Elegir" disabled>Elegir</option>
